...
public class SortAlg {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.println("버블정렬 : " + bubbleTime + "ms");
		System.out.println("선택정렬 : " + selectionTime + "ms");
		System.out.println("삽입정렬 : " + insertionTime + "ms");
		System.out.println("쉘정렬 : " + shellTime + "ms");
		System.out.println("힙정렬 : " + heapTime + "ms");
		System.out.println("기수정렬 : " + radixTime + "ms");
	}
